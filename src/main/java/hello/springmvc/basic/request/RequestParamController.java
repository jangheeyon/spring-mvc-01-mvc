...
public class RequestParamController {
     ...
     * 주의!
     * /request-param-required?username= -> ""(빈문자)로 통과, "" != null
     ...
     * 생략시, String, int 같은 단순 타입은 @RequestParam
     * 그 외에는 @ModelAttribute (argument resolver(HttpServletResponse 등...)로 지정해둔 타입 외)
     */
    @ResponseBody
